...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    set_of_foods1 = set(foods1)
    set_of_foods2 = set(foods2)
    sorted_common_foods = sorted([item for item in foods1 if item in set_of_foods1 & set_of_foods2])
    return sorted_common_foods
